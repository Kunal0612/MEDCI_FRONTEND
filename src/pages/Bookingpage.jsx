...
const Bookingpage = () => {
  ...
  const getUserData = async () => {
    try {
      const res = await axios.post(
        "https://medci-backend-oiwj.onrender.com/api/v1/doctor/getDoctorById",
  ...
  const handleBooking = async () => {
    try {
      ...
      const res = await axios.post(
        "https://medci-backend-oiwj.onrender.com/api/v1/user/book-appointment",
        {
          doctorId: params.doctorId,
          userId: user._id,
          doctorInfo: doctors,
  ...
  const handleAvailability = async () => {
    try {
      dispatch(showLoading());
      const res = await axios.post(
        "https://medci-backend-oiwj.onrender.com/api/v1/user/booking-availbility",
